...
const HomePage = () => {
  ...
  return(
    <div className="flex flex-col gap-12">
        <div className="md:px-32 bg-white rounded-lg shadw-md py-8 flex flex-col gap-5 text-center -mt-16">
        ...
        <div className="grid md:grid-cols-2 gap-5">
            ...
            <div className="flex flex-col item-center justify-center gap-4 text-center">
                ...
                <span>
                    Download the MernFoodie App for faster ordering and personalised recommendations
                </span>
